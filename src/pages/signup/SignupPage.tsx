...
import { User, Mail, Lock, Phone, Eye, EyeOff, Plane } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-gray-700">성</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-gray-700">이름</Label>
                  <Input
                    id="firstName"
                    required
              ...
              {/* Phone */}
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-gray-700">휴대폰 번호</Label>
                <div className="relative">
              ...
              <label className="flex items-start gap-2 text-gray-600 cursor-pointer">
                ...
                <span>
                  ...
                  <a href="#" className="text-blue-600 hover:underline">개인정보 처리방침</a>에 동의합니다
                </span>
              </label>
