import { adminNavigation } from "@features/inquiry/data/inquiries";
import { DashboardPage as Dashboard } from "./views/DashboardPage";
import { InquiriesPage as InquiryAdmin } from "./views/InquiriesPage";
